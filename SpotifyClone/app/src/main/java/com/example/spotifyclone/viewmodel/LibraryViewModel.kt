...
data class LibraryUiState(
    ...
    val selectedFilter: String = "Playlists",
            ...
            try {
                when (filter) {
                    "Playlists" -> {
                        ...
                        _uiState.update {
                            it.copy(playlists = response.data ?: emptyList())
                        }
                    }
                    ...
                    "Artists" -> {
                        ...
                        _uiState.update {
                            it.copy(artists = response.data ?: emptyList())
                        }
                    }
                    ...
                    "Albums" -> {
                        ...
                        _uiState.update {
                            it.copy(albums = response.data ?: emptyList())
                        }
                    }
                }
            } catch (e: Exception) {
                _uiState.update {
                    it.copy(error = "Không thể tải dữ liệu thư viện")
                }
            } finally {
                _uiState.update {
